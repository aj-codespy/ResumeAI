      ...
      <Card className="text-center p-8 rounded-xl border">
        <CardHeader>
          ...
          <CardDescription className="mt-3 text-md text-foreground/80 max-w-2xl mx-auto">
            Craft your perfect resume with the power of Artificial Intelligence. Generate a new resume from scratch or revamp your existing one.
          </CardDescription>
        </CardHeader>
      </Card>

      <Tabs defaultValue="generate" className="w-full">
        <TabsList className="grid w-full grid-cols-1 md:grid-cols-2 md:w-1/2 mx-auto">
